...
<nav class="navbar navbar-expand-lg navbar-dark  bg-dark">
  <h1 class="navbar-brand">Back End Service</h1>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item" id="GoodsList" value="123">      	
        <a class="nav-link" href="BackendServlet.do?action=queryGoods">商品列表</a>
      </li>      
      <li class="nav-item">
        <a class="nav-link" href="BackendServlet.do?action=updateGoodsView">商品維護</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="BackendServlet.do?action=addGoodsView">商品新增上架</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="BackendServlet.do?action=querySalesReportView">銷售報表</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="FrontendServlet.do?action=buyGoodsView">前端販賣機</a>
      </li>
    </ul>
